  ...
  return (
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img
          src="https://cdn.poehali.dev/projects/5222242b-1f96-4301-89a1-3d7cf2808dfb/bucket/729859ba-da71-4148-88d1-216951c6828b.jpg"
          alt="Дизайн интерьера квартиры"
      ...
      >
        <div className="mb-72 md:mb-60 lg:mb-80">
          <p className="text-sm tracking-[0.3em] uppercase text-center text-secondary mb-0">{"Дизайн интерьеров квартир"}</p>
          ...
          >
            {"Превращаем квартиру"}
            <br />
            <span className="text-orange-200">{"в мечту"}</span>
          </h1>
        </div>
      </div>
